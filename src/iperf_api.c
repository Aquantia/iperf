...
#include <sys/sysinfo.h>
    ...
    #error Your configuration isn't supporting LSO dor UDP! If you want to use it on\
 another configuration, please temporary change your version in file\
...
iperf_parse_arguments(struct iperf_test *test, int argc, char **argv)
{
    static struct option longopts[] =
    {
        ...
        {"lso-udp", required_argument, NULL, OPT_LSO_UDP},
        {NULL, 0, NULL, 0}
    };
    int flag;
    int blksize;
    ...
    while ((flag = getopt_long(argc, argv, "p:f:i:D1VJvsc:ub:t:n:k:l:P:Rw:B:M:N46S:L:ZO:F:A:T:C:dI:hX:", longopts, NULL)) != -1) {
        switch (flag) {
            ...
            case 'h':
                ...
                exit(0);
            case OPT_LSO_UDP:
                test->settings->lso_udp = 1;
                test->settings->lso_udp_segsize = unit_atoi(optarg);
                break;
            default:
                usage_long(stderr);
                exit(1);
